    ...
    <section class="hero">
        ...
        <div class="wrapper">
            <div class="content">
                ...
                <p v-if="step !== 8 && step !== 9">Wir haben <strong>551 weibliche Mitglieder</strong> im Umkreis von <strong>10 Meilen</strong> um Ihren aktuellen Standort. Diese Frauen suchen <strong>NUR nach ungezwungenen sexuellen Begegnungen</strong>. Sie haben Glück, im Moment ist die <strong>KOSTENLOSE Registrierung für Männer</strong> für weitere <strong>@{{ minutes }}</strong> Minuten und <strong>@{{ seconds }}</strong> Sekunden geöffnet... Alles, was wir von Ihnen verlangen, ist die Beantwortung von drei einfachen Fragen, um zu sehen, ob Sie sich für unsere exklusive Website qualifizieren. <strong>Viel Glück</strong></p>
                <article v-if="step === 1">
                ...
                <article v-if="step === 9" class="text-left step-9">
                    ...
                    <p class="clr-green">Die Nichteinhaltung dieser Regeln führt zur sofortigen Kündigung Ihres Kontos!
...
<script>
    ...
    createApp({
        ...
        data() {
            return {
                slides: [
                    'assets/lp10/images/img1.jpg',
                    'assets/lp10/images/img2.jpg',
                    'assets/lp10/images/img3.jpg',
                    'assets/lp10/images/img4.jpg',
                ],
                currentIndex: 0,
                step:1,
                progressWidth: 0,
