    ...
    <section class="hero">
        ...
        <div class="wrapper">
            <div class="content">
                ...
                <p v-if="step !== 8 && step !== 9">Wir haben <strong class="clr-blue">551 weibliche Mitglieder</strong> im Umkreis von <strong class="clr-blue">10 Meilen</strong> um Ihren aktuellen Standort. Diese Frauen suchen <strong class="clr-blue">NUR nach ungezwungenen sexuellen Begegnungen</strong>. Sie haben Glück, im Moment ist die <strong class="clr-blue">KOSTENLOSE Registrierung für Männer</strong> für weitere <strong class="clr-blue">@{{ minutes }}</strong> Minuten und <strong class="clr-blue">@{{ seconds }}</strong> Sekunden geöffnet... Alles, was wir von Ihnen verlangen, ist die Beantwortung von drei einfachen Fragen, um zu sehen, ob Sie sich für unsere exklusive Website qualifizieren. <strong class="clr-blue">Viel Glück</strong></p>
                <article v-if="step === 1">
...
<script>
    ...
    createApp({
        ...
        data() {
            return {
                slides: [
                    'assets/lp9/images/img1.jpg',
                    'assets/lp9/images/img2.jpg',
                    'assets/lp9/images/img3.jpg',
                    'assets/lp9/images/img4.jpg',
                ],
                currentIndex: 0,
                step:1,
                progressWidth: 0,
