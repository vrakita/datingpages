    ...
    <section class="hero">
        ...
        <div class="wrapper">
            <div class="content">
                ...
                <p v-if="step !== 8 && step !== 9">Wir haben <strong class="clr-red">551 weibliche Mitglieder</strong> im Umkreis von <strong class="clr-red">10 Meilen</strong> um Ihren aktuellen Standort. Diese Frauen suchen <strong class="clr-red">NUR nach ungezwungenen sexuellen Begegnungen</strong>. Sie haben Glück, im Moment ist die <strong class="clr-red">KOSTENLOSE Registrierung für Männer</strong> für weitere <strong class="clr-red">@{{ minutes }}</strong> Minuten und <strong class="clr-red">@{{ seconds }}</strong> Sekunden geöffnet... Alles, was wir von Ihnen verlangen, ist die Beantwortung von drei einfachen Fragen, um zu sehen, ob Sie sich für unsere exklusive Website qualifizieren. <strong class="clr-red">Viel Glück</strong></p>
                <article v-if="step === 1">
...
<script>
    ...
    createApp({
        ...
        data() {
            return {
                slides: [
                    'assets/lp8/images/img1.jpg',
                    'assets/lp8/images/img2.jpg',
                    'assets/lp8/images/img3.jpg',
                    'assets/lp8/images/img4.jpg',
                    'assets/lp8/images/img5.jpg',
                ],
                currentIndex: 0,
                step:1,
                progressWidth: 0,
